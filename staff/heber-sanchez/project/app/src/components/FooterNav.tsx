...
function FooterNav({ onCreateFormClick }) {
    ...
    return <>
        <nav className="fixed bottom-0 w-full flex justify-between items-center box-border  bg-[#344C11] p-4">
            ...
            {logic.getLoggedInfo().role === 'manager' && (<button onClick={handleClickCreateForm}><img className='w-8 h-8 top-1' src='/public/create-icon.png' alt='create match icon' /></button>)}
