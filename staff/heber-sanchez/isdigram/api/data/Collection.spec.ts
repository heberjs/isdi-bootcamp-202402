...
describe("Collection", () => {
  describe("constructor", () => {
    it("creates a collection", () => {
      const car = new Collection("cars");

      expect(car).to.be.instanceOf(Collection);
    });
  });

  describe(">helpers", () => {
    describe("_.generateId", () => {
        ...
        writeFile(
          ...
          (error) => {
            ...
            cars._loadDocuments((error, documents) => {
              ...
              expect(document.brand).to.be.equal("fiat");
              expect(document.model).to.be.equal("500");
    ...
    describe("_saveDocuments", () => {
      ...
      it("fails on non-Array documents", () => {
        const documents = "Hello Documents";
  ...
  describe("> CRUD", () => {
    describe("findOne", () => {
      it("find an existing document", (done) => {
        writeFile(
          "./data/cars.json",
          '[{"brand":"porsche","model":"911"},{"brand":"fiat","model":"500"}]',
          (error) => {
    ...
    describe("updateOne", () => {
      ...
      it("fails on no callback", () => {
        ...
        expect(errorThrown).to.be.instanceOf(TypeError);
        expect(errorThrown.message).to.be.equal("callback is not a function");
      });
    });
    describe("deleteOne", () => {
