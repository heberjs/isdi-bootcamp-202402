...
}
{
  ...
  assert.equalsValue(sultan.eating, "banana");
}
{
...
}
{
  ...
  var errorThrown;
  try {
    new Animal(null, new Date(2000, 0, 1, 16, 45), "GB", 50);
  } catch (error) {
    errorThrown = error;
  }
...
{
  console.log("CASE constructor fail on non-string country");
...
{
  console.log("CASE constructor fail on non-number weight");
